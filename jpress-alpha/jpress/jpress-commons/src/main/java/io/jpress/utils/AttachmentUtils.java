...
public class AttachmentUtils {
	...
	static List<String> docSuffix = new ArrayList<String>();//20180118 shixiaolin
	static List<String> pdfSuffix = new ArrayList<String>();//20180118 shixiaolin
	static {
		imageSuffix.add(".jpg");
	...
	public static boolean isDoc(String path){
		String sufffix = FileUtils.getSuffix(path);
		if (StringUtils.isNotBlank(sufffix))
			return docSuffix.contains(sufffix.toLowerCase());
		return false;
	}
	...
	public static boolean isPdf(String path){
		String sufffix = FileUtils.getSuffix(path);
		if (StringUtils.isNotBlank(sufffix))
			return pdfSuffix.contains(sufffix.toLowerCase());
		return false;
	}
