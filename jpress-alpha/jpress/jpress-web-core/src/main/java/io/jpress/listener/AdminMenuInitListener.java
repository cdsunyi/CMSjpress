...
public class AdminMenuInitListener implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		//menuMnager.addMenuGroup(createWechatMenuGroup()); //20180124

		menuMnager.addMenuGroup(MenuGroup.createBlockGroup());

		menuMnager.addMenuGroup(createUserMenuGroup());
		//menuMnager.addMenuGroup(createTemplateMenuGroup());//20180124
		//menuMnager.addMenuGroup(createAddonMenuGroup());//20180124
		//menuMnager.addMenuGroup(createSettingMenuGroup());//20180124
		//menuMnager.addMenuGroup(createToolsMenuGroup());//20180124
	}
	...
	public void initModuleMenuGroup(MenuManager menuMnager) {
		...
		for (TplModule module : modules) {
			...
			System.out.println("laa------------------:"+module.getName());
			//20180124 shixiaolin 不显示页面操作栏
			if(module.getName().equals("page")){
				System.out.println("bbbb------------------:"+module.getName());
				continue;
			}
